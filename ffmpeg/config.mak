...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--arch=x86 --enable-libmp3lame --enable-libx264 --enable-nonfree --enable-gpl --disable-doc --prefix=../
prefix=../
...
SRC_PATH="/Users/jeff/Desktop/filter/ffmpeg"
SRC_PATH_BARE=/Users/jeff/Desktop/filter/ffmpeg
BUILD_ROOT="/Users/jeff/Desktop/filter/ffmpeg"
CC_IDENT=gcc 4.2.1 (Apple Inc. build 5664)
ARCH=x86
CC=gcc
...
LN_S=ln -sf
STRIP=strip -x
CPPFLAGS=-I/opt/local/include -D_ISOC99_SOURCE -D_POSIX_C_SOURCE=200112 -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -DPIC
CFLAGS=-I/opt/local/include   -std=c99 -mdynamic-no-pic -fomit-frame-pointer -fPIC -g -Wdeclaration-after-statement -Wall -Wno-switch -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wno-pointer-sign -Wcast-qual -Wwrite-strings -Wundef -Wmissing-prototypes -O3 -fno-math-errno -fno-tree-vectorize -Werror=implicit-function-declaration -Werror=missing-prototypes
ASFLAGS=   -mdynamic-no-pic -fPIC -g
CC_O=-o $@
LDFLAGS=-L/opt/local/lib -Wl,-dynamic,-search_paths_first
...
EXTRALIBS= -lx264 -lmp3lame -lm -lbz2 -lz 
INSTALL=install
LIBTARGET=
...
LAVFI_TESTS=crop crop_scale crop_scale_vflip crop_vflip null pixdesc_le scale200 scale500 vflip vflip_crop vflip_vflip 
